...
- Specific views (PostView, CommentView, LikeView, ShareView, ReportView): Configure form columns and list columns
...
class UserView(AuthModelView):
    ...
    def _list_formatter(view, context, model, name):
        ...
        return super(UserView, view)._list_formatter(context, model, name)
